...
if (jjtc000) {
  ...
  final private void classe() throws ParseException {/*@bgen(jjtree) Classe */
...
if (jjtc000) {
  ...
  final private void decls() throws ParseException {/*@bgen(jjtree) Decls */
...
if (jjtc001) {
  ...
  final private void vars() throws ParseException {/*@bgen(jjtree) Vars */
...
if (jjtc000) {
  ...
  final private void entetes() throws ParseException {/*@bgen(jjtree) Entetes */
...
if (jjtc001) {
  ...
  final private void instrs() throws ParseException {/*@bgen(jjtree) Instrs */
...
if (jjtc000) {
  ...
  final private void chaine() throws ParseException {/*@bgen(jjtree) Chaine */
...
if (jjtc000) {
  ...
  final private void toIgnoreVnil() throws ParseException {/*@bgen(jjtree) Vnil */
...
if (jjtc000) {
  ...
  final private void toIgnoreEnil() throws ParseException {/*@bgen(jjtree) Enil */
...
if (jjtc000) {
  ...
  final private void toIgnoreInil() throws ParseException {/*@bgen(jjtree) Inil */
...
if (jjtc000) {
  ...
  final private void toIgnoreExnil() throws ParseException {/*@bgen(jjtree) Exnil */
