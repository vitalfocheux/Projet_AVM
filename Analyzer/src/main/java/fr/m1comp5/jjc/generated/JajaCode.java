...
public class JajaCode/*@bgen(jjtree)*/implements JajaCodeTreeConstants, JajaCodeConstants {/*@bgen(jjtree)*/
  ...
  final private void adresse() throws ParseException {
                          Token t;
    number();
  }
  ...
  final private void sorte() throws ParseException {
                               /*@bgen(jjtree) Sorte */
  ...
  final private void number() throws ParseException {
                                 /*@bgen(jjtree) JcNbre */
  ...
  final private void trueValue() throws ParseException {
                                    /*@bgen(jjtree) JcVrai */
  ...
  final private void falseValue() throws ParseException {
                                      /*@bgen(jjtree) JcFalse */
  ...
  final private void string() throws ParseException {
