...
if (jjtc021) {
  ...
  final private void ident() throws ParseException {/*@bgen(jjtree) JcIdent */
...
if (jjtc001) {
  ...
  final private void adresse() throws ParseException {Token t;
    number();
}

  final private void oper() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEG:
    case NOT:{
      oper1();
  ...
  final private void oper1() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEG:{
...
if (jjtc002) {
  ...
  final private void oper2() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ADD:{
...
if (jjtc008) {
  ...
  final private void type() throws ParseException {/*@bgen(jjtree) Type */
...
if (jjtc000) {
  ...
  final private void sorte() throws ParseException {/*@bgen(jjtree) Sorte */
...
if (jjtc000) {
  ...
  final private void number() throws ParseException {/*@bgen(jjtree) JcNbre */
...
if (jjtc000) {
  ...
  final private void trueValue() throws ParseException {/*@bgen(jjtree) JcVrai */
...
if (jjtc000) {
  ...
  final private void falseValue() throws ParseException {/*@bgen(jjtree) JcFalse */
...
if (jjtc000) {
  ...
  final private void string() throws ParseException {/*@bgen(jjtree) JcChaine */
